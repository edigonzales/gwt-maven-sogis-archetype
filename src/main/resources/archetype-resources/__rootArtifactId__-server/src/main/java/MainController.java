...
import ${package}.search.InvalidLuceneQueryException;
import ${package}.search.LuceneSearcher;
import ${package}.search.LuceneSearcherException;
import ${package}.search.Result;
