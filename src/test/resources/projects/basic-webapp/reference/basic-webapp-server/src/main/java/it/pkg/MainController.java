...
import it.pkg.search.InvalidLuceneQueryException;
import it.pkg.search.LuceneSearcher;
import it.pkg.search.LuceneSearcherException;
import it.pkg.search.Result;
...
public class MainController {
    ...
    public ResponseEntity<String> ping() {
        return new ResponseEntity<String>("basic-webapp", HttpStatus.OK);
    }
